...
public abstract class DoubleBufferedCanvas extends Canvas {
	...
	* its BufferStrategy.
	* 
	* @precondition Canvas must be visible before call to createAndSetBuffer();
	*/
	public void createAndSetBuffer() {
		try {
			...
			System.err.print("Canvas must be visible before call to createAndSetBuffer()");
			System.exit(-1);
		}
	...
	*/
	...
	public void update()
	{
		...
		backBufferGFX.setColor(Color.WHITE);
		...
		//Display the Front Buffer on the Canvas.
